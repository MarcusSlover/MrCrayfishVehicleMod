...
import com.mrcrayfish.vehicle.entity.vehicle.PoliceCarEntity;
 ...
 * Author: MrCrayfish
 */
public class PoliceCarRenderer extends AbstractLandVehicleRenderer<PoliceCarEntity>
{
    ...
    @Override
    protected void render(@Nullable PoliceCarEntity vehicle, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, float partialTicks, int light)
    {
        this.renderDamagedPart(vehicle, SpecialModels.POLICE_CAR_BODY.getModel(), matrixStack, renderTypeBuffer, light);
    ...
    @Override
    public void applyPlayerModel(PoliceCarEntity entity, PlayerEntity player, PlayerModel model, float partialTicks)
    {
    ...
    public EntityRayTracer.IRayTraceTransforms getRayTraceTransforms()
    {
        ...
        {
            EntityRayTracer.createTransformListForPart(SpecialModels.POLICE_CAR_BODY, parts, transforms);
            ...
            EntityRayTracer.createFuelPartTransforms(ModEntities.POLICE_CAR.get(), SpecialModels.FUEL_DOOR_CLOSED, parts, transforms);
            EntityRayTracer.createKeyPortTransforms(ModEntities.POLICE_CAR.get(), parts, transforms);
        };
    }
}
